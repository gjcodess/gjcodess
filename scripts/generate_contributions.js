...
.c { opacity: 0; animation: cell 0.42s cubic-bezier(.2,.8,.2,1) both; }</style><defs><linearGradient id="hbg" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#0d1420"/><stop offset="1" stop-color="#0a0e14"/></linearGradient></defs><rect width="869" height="265" rx="12" fill="url(#hbg)"/><rect x="0.5" y="0.5" width="868" height="264" rx="12" fill="none" stroke="#1f6feb" stroke-width="1" stroke-opacity="0.55"/><line x1="0" y1="30" x2="869" y2="30" stroke="#1f6feb" stroke-opacity="0.35"/><circle cx="22" cy="15.0" r="5" fill="#ff5f56"/><circle cx="38" cy="15.0" r="5" fill="#ffbd2e"/><circle cx="54" cy="15.0" r="5" fill="#27c93f"/><text x="434.5" y="19.0" fill="#7d8590" font-size="12" text-anchor="middle">${username}@github: ~/contributions --graph</text>${monthLabelsSvg}<text x="22" y="74.4" fill="#7d8590" font-size="9">Mon</text><text x="22" y="104.4" fill="#7d8590" font-size="9">Wed</text><text x="22" y="134.4" fill="#7d8590" font-size="9">Fri</text>${cellsSvg}<text x="711" y="170.6" fill="#7d8590" font-size="10" text-anchor="end">Less</text><rect x="719" y="161" width="11" height="11" rx="2.2" fill="#161b22"/><rect x="731" y="161" width="11" height="11" rx="2.2" fill="#0e4429"/><rect x="743" y="161" width="11" height="11" rx="2.2" fill="#006d32"/><rect x="755" y="161" width="11" height="11" rx="2.2" fill="#26a641"/><rect x="767" y="161" width="11" height="11" rx="2.2" fill="#39d353"/><rect x="779" y="161" width="11" height="11" rx="2.2" fill="#69f0a0"/><text x="795" y="170.6" fill="#7d8590" font-size="10">More</text><line x1="0" y1="187" x2="869" y2="187" stroke="#1f6feb" stroke-opacity="0.25"/><text x="22" y="211" font-size="13" fill="#39d353"><tspan font-weight="700">${formattedTotal}</tspan><tspan fill="#7d8590"> contributions in the last year</tspan></text><text x="847" y="211" font-size="12" fill="#7d8590" text-anchor="end">${startDateStr} &#8594; ${endDateStr}</text><text x="22" y="235" font-size="13" fill="#7d8590">current streak <tspan fill="#22d3ee" font-weight="700">${currentStreak} days</tspan><tspan fill="#7d8590">   &#183;   longest </tspan><tspan fill="#22d3ee" font-weight="700">${longestStreak} days</tspan></text><text x="847" y="235" font-size="12" fill="#7d8590" text-anchor="end">best day <tspan fill="#f2cc60" font-weight="700">${bestDay.count}</tspan> on ${bestDay.date}</text></svg>`;
}
